...
export const event = {
  ...
  dek: "Denmark announced the visit on September 1. On September 7 the Commission, Greenland, and Denmark signed a declaration that says it creates no legal or financial obligations, and the Commission named a €200 million Global Gateway package for this year and next.",
  ...
  kpis: [
    ...
    { value: "€225", unit: "million", label: "DOAG envelope for Greenland, 2021-2027" },
    { value: "€530", unit: "million", label: "Commission proposal for 2028-2034" },
