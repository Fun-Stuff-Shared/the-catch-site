...
export const subject = {
  ...
  dek: "Canada's counter-tariffs on $27.6 billion of U.S. goods took effect September 8, 17 days after the U.S. 50 percent Section 338 duties took effect.",
  current: [
    { label: "Covered U.S. imports, Finance Canada", value: `$${financeCoveredCad}`, unit: "billion", as_of: "2026-08-25", record_id: "finance-countermeasures-2026-08-25", source_value: "27.6", source_unit: "billion dollars", source_sentence: "Canada's counter tariffs will apply to products covering $27.6 billion in imports from the U.S." },
