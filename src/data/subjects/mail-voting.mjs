export const subject = {
  ...
  current: [
    ...
    { label: "Days to November 3", value: "58", unit: "days", as_of: "2026-09-06", record_id: "scotus-26a305-application", source_value: "58", source_unit: "days", source_sentence: "Ballots have already begun to be mailed in North Carolina" },
